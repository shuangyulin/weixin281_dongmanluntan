    ...
    .menulistImg {
      ...
      .el-image {
		...
		&>.el-menu-item {
			...
			color: rgba(65, 81, 169, 1);
			font-size: 14px;
			border-radius: 0 0 50% 50%;
			border-width: 0;
			border-style: solid;
			border-color: rgba(65, 81, 169, 1) !important;
		...
		& /deep/ .el-submenu__title {
			...
			.el-submenu__icon-arrow {
				...
				width: 12px;
				line-height: 12px;
				color: rgba(65, 81, 169, 1) !important;
				font-size: 12px;
				border-radius: 0;
				border-width: 0;
				border-style: solid;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    border-style: solid;
                    border-color: rgba(0, 0, 0, 0);
                    background-color: rgba(65, 81, 169, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
